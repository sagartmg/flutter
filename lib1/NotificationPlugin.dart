...
class NotificationPlugin {
  ...
  Future<void> showNotification(int title) async {
  ...
  Future<void> scheduleNotification(String title,int secondss) async {
    print('set not');
    var scheduleNotificationDateTime = DateTime.now().add(Duration(seconds: secondss));
    var androidChannelSpecifics = AndroidNotificationDetails(
      'CHANNEL_ID ${secondss}',
      'CHANNEL_NAME ${secondss}',
      "CHANNEL_DESCRIPTION ${title}",
      // icon: 'secondary_icon',
      // sound: true,
